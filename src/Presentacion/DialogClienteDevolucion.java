...
public class DialogClienteDevolucion extends javax.swing.JDialog {

   
    public DialogClienteDevolucion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogClienteDevolucion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogClienteDevolucion dialog = new DialogClienteDevolucion(new javax.swing.JFrame(), true);
     ...
     private void llenar_Tabla() {
        try {
            ...
            modelo= Cliente.fillDataTable("Where Status='No Disponible'");
